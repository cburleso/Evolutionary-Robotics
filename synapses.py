...
# Synapses to connect sensor neurons to joint's motor neuron
#sim.send_synapse(source_neuron_id = SN0, target_neuron_id = MN2_2, weight = -1.0)
sim.send_synapse(source_neuron_id = SN1, target_neuron_id = MN2_2, weight = -1.0)
